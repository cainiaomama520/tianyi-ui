          ...
          <div class="labelItem">
              ...
              <div style="display:inline-block">
                <el-upload
                  ...
                  <video ref='selfVideoS' v-show="currentModel.video" :src="currentModel.video" class="avatar" controls="controls">您的浏览器不支持视频播放</video>
                  <i v-show="!currentModel.video" style="color:#598fe6" class="el-icon-upload avatar-uploader-icon">上传视频</i>
                  <div class="progressDiv" v-if="videoFlag">
                    <el-progress class="progressC" style="left:8%;top:50%" type="circle" color="green" :percentage="videoUploadPercent"></el-progress>
                  </div>
                </el-upload>
                <div class="tipDiv" style="width:160px">
              ...
              <div style="display:inline-block">
                <el-upload
                  ...
                  <div class="progressDiv" v-if="imgFlag">
                    <el-progress class="progressC" style="left:102%;top:50%" type="circle" color="green" :percentage="imgUploadPercent"></el-progress>
                  </div>
                </el-upload>
                <div class="tipDiv" style="width:160px">
