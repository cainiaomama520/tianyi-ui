  ...
  <div>
    <div class="creativeBoy" v-show='backData.length>0'>
      <div class="progCreativeBody">
        ...
        <div class="progItem" v-for='(item,index) in backData' @click='clickAction(index)' style="width:calc(25% - 24px)">
          <div class="icon-box">
          ...
          <div class="display:inline-block">
            <el-upload
              ...
              <div class="progressDiv" v-if="imgFlag && index == currentIndex">
                <el-progress class="progressC" style="left:15%;top:70%" type="circle" color="green" :percentage="videoUploadPercent"></el-progress>
              </div>
            </el-upload>
...
export default {
  ...
  data() {
    return {
      ...
      myData: {advertiser_id:this.$store.state.titlemess.advId,image_mode:3},
      title: '',
